...
export function NewAutoCropId(props: SelfieCameraProps) {
  ...
  return (
    <div className='flex flex-col items-center p-5'>
      ...
      {!props.screenshot && (
        <div className='relative mb-5 overflow-hidden w-75 h-100 rounded-1/2'>
          <video
            width={300}
            height={400}
      ...
      <div className='flex flex-col items-center gap-3 text-black-pure'>
        <p className='text-3xl'>
          {props.screenshot ? 'Is it clear enough?' : 'Take a selfie'}
        </p>
